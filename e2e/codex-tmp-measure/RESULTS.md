...
| **final** (after all 5) | n/a | **875,005,630 (834.48 MiB)** | **5** | 0 | **390 total** |
...
| **final** (after release) | n/a | **0** | **0** | **peak 1,004,013,728 (957.50 MiB); retained: NO; holder reported `cache_cleanup state=removed`** | **78 total** |
