...
// HEALTH_FIELDS drives the run-health threshold inputs (PRD #47). Each is integer
// seconds; 0 disables that one signal. The order matches the detector's signals.
