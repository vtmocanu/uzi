// Settings → Appearance: the per-user theme/mode/typeface control (PRD #1167
// "Lights on") and the per-device Demo-mode card. Split out of the old
// "Account & tokens" tab (Settings.tsx), which had grown to carry credentials
// AND appearance in one scroll; the discriminator mirrors the Run-defaults
// split — Account is who you are and what you hold, this tab is how uzi looks.
// Lives inside SettingsShell so it sits beside Account & tokens / Run defaults.
...
export function AppearanceSettings() {
  const { appearance, refresh } = useAuth();
  ...
  return (
    <SettingsShell description="How uzi looks — theme, mode, and typeface follow you across browsers; demo masking is per device.">
