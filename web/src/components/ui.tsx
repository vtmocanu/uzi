// uzi's primitive kit. Deliberately small (one file, zero dependencies): a
// variant/size matrix on Button, a soft destructive style, an Empty component,
// a Skeleton, a fixed-width unicode Spinner, and a unified PageHeader.
...
// Variant language: a single loud primary, a
// bordered secondary, a quiet ghost, and a SOFT destructive
// (bg-danger/10 text-danger) so
...
// frames never reflow neighbouring text.
...
// EmptyState: dashed container + icon + title + description + action — the
// common Empty/EmptyHeader/EmptyMedia/EmptyTitle slot structure, flattened
// into props at this app's scale.
...
// had drifted (exactly the kind of drift a shared breadcrumb header is built
// to kill).
