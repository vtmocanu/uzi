...
// 1em). Multica leans on the lucide package (see its app-sidebar.tsx imports);
// uzi keeps its zero-dependency budget by inlining just the ~20 glyphs the
// shell and pages actually use.
