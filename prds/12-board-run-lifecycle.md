...
**Status**: Ready (2026-07-04: reviewed by 2 agents — kanban-UX review + adversarial fact-check — all findings incorporated; 2026-07-04 user review added move-retry reconciliation, itself hardened by a second fact-check + design-review agent round; four design changes total, see Design Decisions)
**Priority**: High
**Created**: 2026-07-04
