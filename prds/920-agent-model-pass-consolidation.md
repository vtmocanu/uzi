...
**Related**:
- `agent/src/judge-runner.ts:272` (`runModel`) / `:317` (`consumeModel`); `agent/src/review-runner.ts:187/:215`; `agent/src/summary-runner.ts:207/:236` — the triplication. The code says so itself: review-runner:189 "Same permission handling as JudgeRunner.runModel"; summary-runner:209/:247 "identical to the judge's consumeModel".
