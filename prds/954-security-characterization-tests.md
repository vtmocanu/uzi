...
- [ ] **M1 — S2: GitHub families + the binding test.**
...
- [ ] **M2 — S4: pin the unpinned arms of `TokenInfo`.** In `api/internal/forge/forgejo_test.go`, mirroring the existing fixtures (`TestForgejoTokenInfoParsesScopes` :1016, `TestForgejoTokenInfoAmbiguousCollisionFailsSafe` :1068):
