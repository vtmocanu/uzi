...
- [ ] **M1 — Align-with-default before the finalize push (the core fix).** In `agent/src/runner.ts`, after #377's workflow-modify guard and before `pushBranch`:
