...
- [ ] **M5 — Reply-from-Slack**: thread replies → reject-pending reason / `follow_up` on live runs, ✅ ack reactions, unlinked/finished-run ephemerals (coalesced), per-user inbound rate limit.
