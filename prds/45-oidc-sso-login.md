...
**Status**: Implemented (M1–M7, 2026-07-12) on `feature/prd-45-oidc-sso-login`, awaiting MR. Keycloak verified against a real instance; Pocket ID walkthrough verification remains a manual user step (passkey bootstrap).
**Priority**: Medium
**Created**: 2026-07-12
