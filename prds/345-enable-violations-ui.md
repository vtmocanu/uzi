...
**Status**: M1–M3 implemented (2026-08-20); M4 not undertaken (see Milestones). File stays in `prds/` — not all items complete.
**Priority**: Medium
**Related**:
