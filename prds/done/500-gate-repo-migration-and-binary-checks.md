...
**Priority**: Medium
**Status**: Complete — landed on branch `agent/issue-500` (M1 `check:migration-numbering`, M2 `check:no-binary-text`, M3 doc pointers), all three checks members of `gate:repo`.
