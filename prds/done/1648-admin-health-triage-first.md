...
| 2026-09-25 | M8 closed on the maintainer's own mock-mode visual pass of `3866d07d` instead of before/after screenshots attached to the PR | The maintainer checked every page M8 names in a local mock build, found no regressions, and said M8 can be ticked; the agent run cannot attach images. |
