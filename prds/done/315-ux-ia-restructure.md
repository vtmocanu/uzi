...
**GitHub Issue**: [vtmocanu/uzi#315](https://github.com/vtmocanu/uzi/issues/315)
...
The grouped `AppShell` shell and the unified layout-header pattern were established in PRD #14, whose headers exist precisely to prevent the hand-placed-corner-link drift this PRD finishes removing. No prior-art project models a user-selectable subset of rate-limit meters; that piece is uzi-specific.
