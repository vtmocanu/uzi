...
**GitLab Issue**: [#122](https://github.com/vtmocanu/uzi/-/issues/122)
...
**Priority**: Medium
**Related**: [#218](https://github.com/vtmocanu/uzi/-/issues/218) (**park/requeue work-loss — SHIPPED 0.15.0 + branch `218-m6`, validated live 2026-08-04; it built the durability primitive this PRD's Phase 2 proposed, so Phase 2 is superseded in part — see the banner below and Decisions 7 & 9**), [#110](https://github.com/vtmocanu/uzi/-/issues/110) (checkpoint agent work — closed will-not-implement; **this PRD reopens the door its analysis closed, by a route that PRD did not consider — see Decision 8**), [#105](https://github.com/vtmocanu/uzi/-/issues/105) (session lost on a different-worker requeue), [#41](https://github.com/vtmocanu/uzi/-/issues/41) (plan revision — the gate loop this must not break), [#51](https://github.com/vtmocanu/uzi/-/issues/51) (worker uid split), [#58](https://github.com/vtmocanu/uzi/-/issues/58) (single-uid non-root start — the k8s posture that made #110 unsafe). Durability cluster that landed or was filed AFTER this PRD was drafted and that Phase 2 must be reconciled against: [#216](https://github.com/vtmocanu/uzi/-/issues/216) (worker load-balancing / `ClaimRun` rewrite + affinity grace), [#217](https://github.com/vtmocanu/uzi/-/issues/217) (which credential a resume spends), [#224](https://github.com/vtmocanu/uzi/-/issues/224) (requeue work-loss with no usage limit), [#222](https://github.com/vtmocanu/uzi/-/issues/222) (steering-channel staleness across a re-clone).
