...
**Issue**: [#246](https://github.com/vtmocanu/uzi/-/issues/246) · **Label**: PRD · **Priority**: Medium
**Parent**: [#16](https://github.com/vtmocanu/uzi/-/issues/16) (repo skills — the opt-in, sanitize-and-inject-through-our-own-channel pattern this extends). Related: [#37](https://github.com/vtmocanu/uzi/-/issues/37) (repo agents, the other `.claude/` reader), [#90](https://github.com/vtmocanu/uzi/-/issues/90) (cross-run memory, the nonce-fenced UNTRUSTED-ADVISORY injection pattern reused here).
