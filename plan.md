...
1. <https://github.com/coder/coder> - for agents/VM to see how they provision

We want best practice level of implementation. Some stuff we can deffer for later.
...
For each repo we should have a kanban board similar to bottega - probably based on gitlab labels?
...
The arhitecture will be server/client, the client will be based on anthopic-sdk?
...
can we use agent teams? in sdk? (regardless we should keep a reviwer step/stage)
