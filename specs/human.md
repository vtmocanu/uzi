...
- An approve, reject or request-changes sent at the plan gate is never lost across a credential switch, worker restart or resumed run; it takes effect once its result is saved, and otherwise carries over to the resumed run. (AI-synced 2026-09-26)
...
- A resumed run with an unapproved plan acts on the owner's pending verdicts before it shows the plan again; pending changes are made to the submitted plan rather than re-offering it. (AI-synced 2026-09-26)
- Every ignored verdict is explained in the run feed. (AI-synced 2026-09-26)
