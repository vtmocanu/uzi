...
- **running → paused (structural completion hold)** ([PRD #1226](prds/done/1226-structural-completion-interlock.md),
  ...
  (`criteria: []`) contract at approval, rather than never freezing, so it passes
  the check vacuously instead of never being able to complete. A run's resolved
