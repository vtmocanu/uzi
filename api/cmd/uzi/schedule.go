...
var skipReasonHints = map[string]string{
	"not_eligible": "add the uzi label or assign the issue to uzi, or raise --max-issues",
}
...
const lastFireCappedHint = "newer issues not reached — raise --max-issues, or add the uzi label / assign the issue to uzi"
