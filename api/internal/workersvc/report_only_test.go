...
func TestClampWireReportMdScrubsSecrets(t *testing.T) {
	...
	for _, secret := range []string{
		"glpat-" + "ABCDEFGHIJKLMNOPQRST", // fabricated GitLab PAT fixture, assembled from parts so no contiguous glpat-<20> literal sits in source; asserts report_md secret scrubbing (#279), never a real credential
