...
-- Validate the two CHECKs added NOT VALID in 00242 (PRD #1497 M1): the widened
...
-- an inline validated ADD CONSTRAINT ... CHECK would hold. Split from 00242 so the adds are
...
-- (00242 is the first migration to admit it), and budget_finalize_seconds was added NOT NULL
...
-- pre-00243 state — each constraint present but NOT VALID — by dropping and re-adding it
-- NOT VALID. The CHECK bodies match 00242's Up verbatim; 00242's Down then narrows/drops
