...
-- Validate the set_via CHECK widened NOT VALID in 00221 (PRD #1184 M2): the three-value
...
-- an inline validated ADD CONSTRAINT ... CHECK would hold. Split from 00221 so the add is
...
-- pre-00222 state — the constraint present but NOT VALID — by dropping and re-adding it NOT VALID.
-- The CHECK body matches 00221's Up verbatim (the widened three-value domain). 00221's Down then
