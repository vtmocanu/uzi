...
-- Validate the set_via CHECK widened NOT VALID in 00219 (PRD #1184 M2): the three-value
...
-- an inline validated ADD CONSTRAINT ... CHECK would hold. Split from 00219 so the add is
...
-- pre-00220 state — the constraint present but NOT VALID — by dropping and re-adding it NOT VALID.
-- The CHECK body matches 00219's Up verbatim (the widened three-value domain). 00219's Down then
