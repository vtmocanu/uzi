...
// `f.target` or `f.category` in isolation left the ENTIRE live-DB suite green — 126 pass,
// 0 fail, every time. Only dropping BOTH halves of a join went red. The cause is the shape of
