...
SELECT t.id, t.name, t.description, t.model, t.tools, t.prompt_body, t.is_builtin, t.updated_by, t.created_at, t.updated_at, t.scope, t.user_id, t.customized, t.origin FROM agent_templates t
