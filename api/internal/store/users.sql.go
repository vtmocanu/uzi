...
type GetUserHarnessModelDefaultsRow struct {
...
func (q *Queries) GetUserHarnessModelDefaults(ctx context.Context, id uuid.UUID) (GetUserHarnessModelDefaultsRow, error) {
	row := q.db.QueryRow(ctx, getUserHarnessModelDefaults, id)
	var i GetUserHarnessModelDefaultsRow
	err := row.Scan(&i.DefaultClaudeModel, &i.DefaultCodexModel)
	return i, err
}

const getUserJudgeAnthropicBinding = `-- name: GetUserJudgeAnthropicBinding :one
SELECT judge_anthropic_bind_mode, judge_anthropic_secret_id FROM users WHERE id = $1
`

type GetUserJudgeAnthropicBindingRow struct {
...
func (q *Queries) GetUserJudgeAnthropicBinding(ctx context.Context, id uuid.UUID) (GetUserJudgeAnthropicBindingRow, error) {
	row := q.db.QueryRow(ctx, getUserJudgeAnthropicBinding, id)
	var i GetUserJudgeAnthropicBindingRow
...
const pruneUserSidebarCodexAccounts = `-- name: PruneUserSidebarCodexAccounts :one
UPDATE users u
...
func (q *Queries) PruneUserSidebarCodexAccounts(ctx context.Context, id uuid.UUID) ([]uuid.UUID, error) {
	row := q.db.QueryRow(ctx, pruneUserSidebarCodexAccounts, id)
	var sidebar_codex_account_ids []uuid.UUID
	err := row.Scan(&sidebar_codex_account_ids)
	return sidebar_codex_account_ids, err
}
...
type SetUserAppearanceRow struct {
	AppearanceMode pgtype.Text `json:"appearance_mode"`
	LightTheme     pgtype.Text `json:"light_theme"`
	DarkTheme      pgtype.Text `json:"dark_theme"`
	Typeface       pgtype.Text `json:"typeface"`
...
func (q *Queries) SetUserAttributionEnabled(ctx context.Context, arg SetUserAttributionEnabledParams) (User, error) {
	row := q.db.QueryRow(ctx, setUserAttributionEnabled, arg.ID, arg.AttributionEnabled)
	var i User
	err := row.Scan(
		&i.ID,
		&i.Email,
...
const setUserHarnessModels = `-- name: SetUserHarnessModels :one
UPDATE users
SET default_harness = CASE WHEN $1::bool THEN $2 ELSE default_harness END,
    default_claude_model = CASE WHEN $3::bool THEN $4 ELSE default_claude_model END,
    default_codex_model = CASE WHEN $5::bool THEN $6 ELSE default_codex_model END,
    default_model = CASE WHEN $7::bool THEN $8 ELSE default_model END
WHERE id = $9
RETURNING default_harness, default_claude_model, default_codex_model, default_model
`

type SetUserHarnessModelsParams struct {
	SetHarness         bool        `json:"set_harness"`
	DefaultHarness     pgtype.Text `json:"default_harness"`
	SetClaude          bool        `json:"set_claude"`
	DefaultClaudeModel pgtype.Text `json:"default_claude_model"`
	SetCodex           bool        `json:"set_codex"`
	DefaultCodexModel  pgtype.Text `json:"default_codex_model"`
	SetDefaultModel    bool        `json:"set_default_model"`
	DefaultModel       pgtype.Text `json:"default_model"`
	ID                 uuid.UUID   `json:"id"`
}

type SetUserHarnessModelsRow struct {
	DefaultHarness     pgtype.Text `json:"default_harness"`
	DefaultClaudeModel pgtype.Text `json:"default_claude_model"`
	DefaultCodexModel  pgtype.Text `json:"default_codex_model"`
	DefaultModel       pgtype.Text `json:"default_model"`
...
func (q *Queries) SetUserHarnessModels(ctx context.Context, arg SetUserHarnessModelsParams) (SetUserHarnessModelsRow, error) {
	row := q.db.QueryRow(ctx, setUserHarnessModels,
		arg.SetHarness,
		arg.DefaultHarness,
		arg.SetClaude,
		arg.DefaultClaudeModel,
		arg.SetCodex,
		arg.DefaultCodexModel,
		arg.SetDefaultModel,
		arg.DefaultModel,
		arg.ID,
	)
	var i SetUserHarnessModelsRow
	err := row.Scan(
		&i.DefaultHarness,
		&i.DefaultClaudeModel,
		&i.DefaultCodexModel,
...
const setUserJudgeAnthropicBinding = `-- name: SetUserJudgeAnthropicBinding :one
UPDATE users
...
func (q *Queries) SetUserJudgeAnthropicBinding(ctx context.Context, arg SetUserJudgeAnthropicBindingParams) (User, error) {
	row := q.db.QueryRow(ctx, setUserJudgeAnthropicBinding, arg.JudgeAnthropicBindMode, arg.JudgeAnthropicSecretID, arg.ID)
	var i User
	err := row.Scan(
		&i.ID,
		&i.Email,
...
// own Settings page.
func (q *Queries) SetUserNotifyEarlyReset(ctx context.Context, arg SetUserNotifyEarlyResetParams) (User, error) {
	row := q.db.QueryRow(ctx, setUserNotifyEarlyReset, arg.ID, arg.NotifyEarlyLimitReset)
	var i User
	err := row.Scan(
		&i.ID,
		&i.Email,
...
const setUserSidebarCodexAccounts = `-- name: SetUserSidebarCodexAccounts :one
UPDATE users SET sidebar_codex_account_ids = $1::uuid[] WHERE id = $2
RETURNING sidebar_codex_account_ids
`

type SetUserSidebarCodexAccountsParams struct {
	SidebarCodexAccountIds []uuid.UUID `json:"sidebar_codex_account_ids"`
	ID                     uuid.UUID   `json:"id"`
}
...
func (q *Queries) SetUserSidebarCodexAccounts(ctx context.Context, arg SetUserSidebarCodexAccountsParams) ([]uuid.UUID, error) {
	row := q.db.QueryRow(ctx, setUserSidebarCodexAccounts, arg.SidebarCodexAccountIds, arg.ID)
	var sidebar_codex_account_ids []uuid.UUID
	err := row.Scan(&sidebar_codex_account_ids)
	return sidebar_codex_account_ids, err
}
