...
// CHECK constraint over exactly these THIRTEEN values (runs_status_check, declared inline
...
// 'pool_wait' by PRD #754, 'paused' by PRD #1190, and 'recovery_wait' by issue
// #1197). A value
...
var knownRunStatuses = map[string]struct{}{
	...
	// is an owner-requested park, resumed on demand. recovery_wait (issue #1197) is a
	// transient-recovery park that auto-resumes on a capped backoff until it recovers
	// or the owner cancels. All six are NON-terminal and deliberately absent from
	// terminalRunStatuses below.
	"limit_wait": {}, "awaiting_input": {}, "awaiting_followup": {}, "pool_wait": {}, "paused": {}, "recovery_wait": {},
