...
export class RunRunner {
  ...
  private buildFlight(
    ...
    // PRD #1247 M5b: wire the batcher from the claim so EVERY appended batch carries
    // claim_generation (the batcher was built above without it). Transparent in normal
    // operation — stamping a generation the fence already matches changes no outcome.
    batcher.setClaimGeneration(claimGeneration);
