...
const RUN_SCRATCH_GUIDANCE = [
  ...
  "Scratch survives only while this same runner clone is retained through a park/resume;",
  "a fresh reseed or cross-worker recovery starts empty, and settled retirement removes it.",
