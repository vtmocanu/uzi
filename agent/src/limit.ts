...
// both). multica classifies provider limits by matching error text; we deliberately
// diverge, because a provider rewording a message must not silently disable the
// feature. Everything below reads a declared field.
//
