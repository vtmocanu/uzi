...
- **`uzi findings stats` and `uzi findings undo <id>` join the findings CLI, and `list`/`review backlog` catch up on rendering ([#1183](https://github.com/vtmocanu/uzi/issues/1183)).**
...
- **The Findings backlog now matches Judge's triage page, including a filed finding turning Done when its issue closes on the forge ([#1183](https://github.com/vtmocanu/uzi/issues/1183)).**
