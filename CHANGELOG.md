...
- **The worker scratch path and sandbox guarantee are documented ([#1719](https://github.com/vtmocanu/uzi/issues/1719)).**
  ADR-1719 defines the `.uzi/scratch/` path for run artifacts, its ephemeral lifecycle and publication refusal; the worker now provisions and locally excludes scratch, while publication and guidance work remains in progress.
